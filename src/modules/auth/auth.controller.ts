...
import { registerUser, sendVerificationEmail, loginUser } from "./auth.service";
...
export const register = async (req: Request, res: Response) => {
  ...
  await emailQueue.add("sendVerificationEmail",{email: user.email, token: verificationToken});
